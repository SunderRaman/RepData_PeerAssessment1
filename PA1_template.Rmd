...
This is the project for the **Reproducible Research** course (Week-2) in Coursera's Data Science specialization course. 
...
Recount total steps by day and create a histogram. 
```{r}
